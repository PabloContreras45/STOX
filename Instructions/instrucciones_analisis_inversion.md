...
**Mínimo obligatorio: 5 candidatos por bucket (15 en total)** que no estén ya en el portfolio.
...
- [ ] Hay **mínimo 5 candidatos por bucket** (Core, Satellite, Wildshots) que no estén en el portfolio
